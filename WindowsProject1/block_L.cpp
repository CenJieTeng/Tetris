...
bool Block_L::ChangeBlock(int map[Width][Height])
{
	int tempState = State;
	POINT tempShape[4];
	for (int i = 0; i < 4; i++)
	...
	{
	case 1:
		Shape[0] = { Shape[0].x - 0, Shape[0].y - 2 };
		Shape[1] = { Shape[1].x + 1, Shape[1].y - 1 };
		//Shape[2] = { Shape[2].x + 0, Shape[2].y - 1 };
		Shape[3] = { Shape[3].x - 1, Shape[3].y + 1 };
		break;
	case 2:
		Shape[0] = { Shape[0].x - 2, Shape[0].y + 0 };
		Shape[1] = { Shape[1].x - 1, Shape[1].y - 1 };
		Shape[2] = { Shape[2].x + 0, Shape[2].y + 0 };
		Shape[3] = { Shape[3].x + 1, Shape[3].y + 1 };
		break;
	case 3:
		Shape[0] = { Shape[0].x + 0, Shape[0].y + 2 };
