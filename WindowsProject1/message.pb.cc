...
class RegisterMsgDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<RegisterMsg> _instance;
...
static void InitDefaultsRegisterMsg_message_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<0> scc_info_RegisterMsg_message_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsRegisterMsg_message_2eproto}, {}};
...
void InitDefaults_message_2eproto() {
  ...
  ::google::protobuf::internal::InitSCC(&scc_info_RegisterMsg_message_2eproto.base);
}
...
const ::google::protobuf::uint32 TableStruct_message_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::RegisterMsg, username_),
  PROTOBUF_FIELD_OFFSET(::RegisterMsg, passward_),
  PROTOBUF_FIELD_OFFSET(::RegisterMsg, result_),
};
static const ::google::protobuf::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::ServerMsg)},
  { 10, -1, sizeof(::GameMsg)},
  { 18, -1, sizeof(::RegisterMsg)},
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::google::protobuf::Message*>(&::_RegisterMsg_default_instance_),
};
...
class RegisterMsg::HasBitSetters {
 public:
};

#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int RegisterMsg::kUsernameFieldNumber;
const int RegisterMsg::kPasswardFieldNumber;
const int RegisterMsg::kResultFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
void RegisterMsg::SharedCtor() {
  ::google::protobuf::internal::InitSCC(
      &scc_info_RegisterMsg_message_2eproto.base);
  username_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  passward_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  result_ = false;
}
...
#if GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
const char* RegisterMsg::_InternalParse(const char* begin, const char* end, void* object,
                  ::google::protobuf::internal::ParseContext* ctx) {
  auto msg = static_cast<RegisterMsg*>(object);
  ::google::protobuf::int32 size; (void)size;
  int depth; (void)depth;
  ::google::protobuf::uint32 tag;
  ::google::protobuf::internal::ParseFunc parser_till_end; (void)parser_till_end;
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        ...
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ctx->extra_parse_data().SetFieldName("RegisterMsg.username");
      ...
      case 2: {
        ...
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ctx->extra_parse_data().SetFieldName("RegisterMsg.passward");
...
// @@protoc_insertion_point(generalized_merge_from_start:RegisterMsg)
  ...
  const RegisterMsg* source =
      ::google::protobuf::DynamicCastToGenerated<RegisterMsg>(
          &from);
  if (source == nullptr) {
...
template<> PROTOBUF_NOINLINE ::RegisterMsg* Arena::CreateMaybeMessage< ::RegisterMsg >(Arena* arena) {
  return Arena::CreateInternal< ::RegisterMsg >(arena);
}
}  // namespace protobuf
}  // namespace google
